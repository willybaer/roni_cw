...
CLIENT_SECRET = 'QB1H-pTJNRRbZSyKu8a9fxS6Fd6aiMVKnbh2vpPj159R2qHD3xexCkzhtbRvKI8spiJrkPLVFU5tISwldFYGBeKQSL9zVqiN7r6wl9wz0UKKByPPLqgAvaZV79TJW3Yx'
API_KEY = 'QB1H-pTJNRRbZSyKu8a9fxS6Fd6aiMVKnbh2vpPj159R2qHD3xexCkzhtbRvKI8spiJrkPLVFU5tISwldFYGBeKQSL9zVqiN7r6wl9wz0UKKByPPLqgAvaZV79TJW3Yx'
...
def main():
    ...
    if squares and len(squares) > 0:
        bearer_token = API_KEY# TODO: THIS is no longer required ... obtain_bearer_token(API_HOST, TOKEN_PATH)
